...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Hero godwoken = new Hero("Ifan",2000,200,150,190,25,50,15);

    Monster voidwoken = new Monster("Voidwoken Abomination",2500,100,100,130,50,5,5);
    ...
    protected void onCreate(Bundle s) {
        ...
        txtHeroName.setText(godwoken.getUnitName());
        txtMonsName.setText(voidwoken.getUnitName());
        ...
        txtHeroHP.setText(String.valueOf(godwoken.getBaseHealth()));
        txtMonsHP.setText(String.valueOf(voidwoken.getBaseHealth()));
        /** to display the damage ranges of of player and enemy, i showed the minimum damage, the the maximum possible damage **/
        txtHeroDPT.setText(godwoken.getMinDPT()+ " ~ "+godwoken.getMaxDPT());
        txtMonsDPT.setText(voidwoken.getMinDPT()+ " ~ "+voidwoken.getMaxDPT());
    ...
    public void onClick(View v){
        ...
        int heroDPT = randomizer.nextInt(godwoken.getMaxDPT() - godwoken.getMinDPT()) + godwoken.getMinDPT();
        int monsDPT = randomizer.nextInt(voidwoken.getMaxDPT() - voidwoken.getMinDPT()) + voidwoken.getMinDPT();
        ...
        switch (v.getId()){
            case R.id.btnNextTurn:
                ...
                if(turnNumber%2 == 1){
                    ...
                    voidwoken.setBaseHealth(voidwoken.getBaseHealth() - heroDPT);
                    turnNumber++;
                    /** We have created a combat log to show how much damage was dealt**/
                    txtCombatLog.setText("The Godwoken dealt " +heroDPT+ " damage to the Voidwoken. Well done!");
                    ...
                    if (voidwoken.getBaseHealth() < 0){
                        txtCombatLog.setText("The Godwoken dealt " +heroDPT+ " damage to the Voidwoken. The Seven has rendered their chosen victorious!");
                        godwoken.setBaseHealth(2000);
                        voidwoken.setBaseHealth(2500);
                        turnNumber = 1;
                 ...
                 * any further as it is just a mirror of the code we have for the player turn**/
                    ...
                    godwoken.setBaseHealth(godwoken.getBaseHealth() - monsDPT);
                    turnNumber++;
                    txtCombatLog.setText("Curses! The Voidwoken dealt " +monsDPT+ " damage to the Godwoken.");
                    txtHeroHP.setText(String.valueOf(godwoken.getBaseHealth()));
                    nextTurn.setText("Player's Turn ("+turnNumber+ ")");
                    if (godwoken.getBaseHealth() < 0){
                        txtCombatLog.setText("The Voidwoken dealt " +monsDPT+ " damage to the Godwoken. The Seven's chosen is dead! Lucian help us...");
                        godwoken.setBaseHealth(2000);
                        voidwoken.setBaseHealth(2500);
                        turnNumber = 1;
                        nextTurn.setText("Reset Game");
